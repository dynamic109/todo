...
const TasksLists = () => {
  ...
  return (
    <div>
      ...
      {filteredTasks.length === 0 && selectedCategory ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-500 mb-4">
              This category doesn't have any tasks yet. Try selecting a different category or create a new task.
            </p>
          </div>
        </div>
      ) : (
                    ...
                    <div className="p-6 flex items-center justify-between">
                      <div className="flex-1 space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                              taskStatus === TASK_STATUS.COMPLETED ? 'bg-green-100 text-green-800' :
                              taskStatus === TASK_STATUS.NOT_COMPLETED ? 'bg-red-100 text-red-800' :
                        ...
                        <div className="flex items-center gap-3 pt-2">
                          <button
                            onClick={() => handleTaskStatusToggle(task.id, category.category, taskStatus)}
                      ...
                      <div className="ml-6 flex-shrink-0 max-w-[120px]">
                        <img 
                          src={bgImage} 
                          alt={`Task ${taskStatus}`} 
