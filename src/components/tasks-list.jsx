                      ...
                      <div className="py-6 px-3 lg:px-6 flex items-center justify-between">
                        <div className="flex-1 space-y-3">
                          <div className="flex items-start md:items-center justify-between">
                            ...
                            <div className="flex flex-col-reverse md:flex-row items-end md:items-start justify-end gap-2">
                              {task.id === clickedTaskId && (
                                <div
                                  ref={dropdownRef}
                                  className="flex flex-col gap-2 absolute right-0 top-0 bg-white shadow-lg text-sm font-manrope font-medium z-10"
                                >
                                  <button
                                    className="text-left hover:bg-gray-200 py-4 pr-8 pl-3"
                                    onClick={() => {
                                      setSelectedTaskData({
                                        task,
